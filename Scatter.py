...
MinList = []
MinList1 = []
AmplitudeList = [-27.6,-27.4,-27.2,-27.0,-26.8]
RangeNum = len(AmplitudeList) - 1
for i in range(RangeNum):
    Amplitude2HistList.append(TH1F("Amplitude2_{}".format(i+1),"",26,-27.8,-26))
AmplitudeHist_2D = TH2F("Amplitude2D","",28,-28.2,-26.4,28,-27.8,-26.2)
